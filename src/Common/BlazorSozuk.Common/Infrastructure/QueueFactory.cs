...
public static class QueueFactory
{
    ...
    public static EventingBasicConsumer CreateBasiConsumer()
    {
    ...
    public  static EventingBasicConsumer EnsurExchange(this EventingBasicConsumer consumer,
                                                    string exchangeName, 
                ...
                Action<T> action)
    {
        consumer.Received += (m, eventArgs) =>
        {
            ...
            var model = JsonSerializer.Deserialize<T>(messsage);
